...
[![Update Ecosystem](https://github.com/buyixian/pi-ecosystem-docs/actions/workflows/update-ecosystem.yml/badge.svg)](https://github.com/buyixian/pi-ecosystem-docs/actions/workflows/update-ecosystem.yml)
...
| 文档 | 说明 |
|------|------|
| [生态总览](docs/pi-ecosystem-overview.md) | 全貌：2,364 个包、34 细分类别、扩展架构、Top 20 榜单 |
