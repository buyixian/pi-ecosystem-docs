...
> 145 个包 | 最高月下载量 34,332 (pi-web-access)

## 概述

Web 类扩展为 PI 提供网络搜索、URL 获取、内容抓取、PDF 解析等能力，让代理能够访问实时信息。

## 推荐扩展

### pi-web-access ⭐
- 📦 `pi-web-access` | 34,332/月
- 🔧 功能：Web 搜索 + URL 获取 + GitHub 仓库克隆 + PDF 提取 + YouTube 理解
- 💡 适用场景：综合 Web 访问需求

### pi-web-providers
- 📦 `pi-web-providers` | 1,377/月
- 🔧 功能：可配置多提供商路由，支持 20+ 搜索引擎后端
- 💡 适用场景：需要灵活切换搜索引擎

### @ollama/pi-web-search
- 📦 `@ollama/pi-web-search` | 26,114/月
- 🔧 功能：使用 Ollama 的 Web 搜索和获取 API
- 💡 适用场景：Ollama 用户
...
| 特性 | pi-web-access | pi-web-providers | @ollama/pi-web-search | rpiv-web-tools |
|------|:---:|:---:|:---:|:---:|
| 通用搜索 | ✅ | ✅(20+) | ✅ | ✅(Brave) |
| URL 获取 | ✅ | ✅ | ✅ | ✅ |
| PDF 解析 | ✅ | ❌ | ❌ | ❌ |
